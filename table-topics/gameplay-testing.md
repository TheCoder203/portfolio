...
<div style="display:flex;gap:10px;flex-wrap:wrap;">
  ...
  <a href="{{site.baseurl}}/gameplay-testing-lesson" style="text-decoration:none;"><div style="background-color:#10b981;color:white;padding:10px 18px;border-radius:8px;font-weight:bold;">Open Lesson Notebook</div></a>
</div>
